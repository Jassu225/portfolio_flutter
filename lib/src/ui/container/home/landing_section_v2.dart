    ...
    return AnimatedBuilder(
      ...
      builder: (_, __) {
        ...
        return Column(
          ...
          crossAxisAlignment: isLargeDevice
          ...
          children: [
            ...
            FadeInMoveUpWidget(
                ...
                child: CustomText.Text(
                  'A web enthusiast',
                  textAlign: isLargeDevice ? TextAlign.start : TextAlign.center,
                ),
                controller: controller,
                intervalBegin: 0.7,
                intervalEnd: 1)
  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      new Timer(const Duration(milliseconds: 500), () {
        if (isMounted()) transitionController.forward();
      });
    }, []);

    return _LandingSectionContent(controller: transitionController);
  }
}
